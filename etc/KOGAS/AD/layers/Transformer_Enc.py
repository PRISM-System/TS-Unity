...
class series_decomp1d(nn.Module):
    """
    Series decomposition block
    """
    def __init__(self, kernel_size):
        super(series_decomp1d, self).__init__()
        self.moving_avg = [moving_avg1d(kernel, stride=1) for kernel in kernel_size]
...
class series_decomp2d(nn.Module):
    """
    Series decomposition block
    """
    def __init__(self, kernel_size):
        super(series_decomp2d, self).__init__()
        self.moving_avg = [moving_avg2d(kernel, stride=1) for kernel in kernel_size]
        self.layer = torch.nn.Linear(1, len(kernel_size))
